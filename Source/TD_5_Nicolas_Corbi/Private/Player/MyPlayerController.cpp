...
void AMyPlayerController::BeginPlay()
{
	...
	PauseWidget->OnRestartButtonClicked.AddDynamic(this, &AMyPlayerController::OnRestartButtonClicked);
...
void AMyPlayerController::ToggleMenu(const FInputActionValue& Value)
{
	...
	UGameplayStatics::SetGamePaused(GetWorld(), IsPauseMenuOpened);
